...
// destination: Eco-Fort/src/replay_lane_promotion_phx.rs
...
pub fn replay_lane_promotion(conn: &Connection, cfg: &ReplayConfig) -> rusqlite::Result<i64> {
    ...
    for r in rows {
        let (shard_id, ts_end, k_old, k_new, e_old, e_new, r_old, r_new, vt_old, vt_new, v_old, v_new) =
            r?;
