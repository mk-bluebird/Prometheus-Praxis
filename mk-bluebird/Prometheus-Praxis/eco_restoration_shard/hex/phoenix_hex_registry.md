...
## Daily cyboquatic workload energy ΔVt shard (CYBOQUATIC/WORKLOAD_ENERGY_DV)
...
- Default path: eco_restoration_shard/cyboquatic_workload
- Files:
  - README: eco_restoration_shard/cyboquatic_workload/README.md
  - CPP: cpp/eco_restoration/cyboquatic_workload_model.cpp
  - JAVA: java/cyboquatic/TelemetryClient.java
  - KOTLIN: kotlin/cyboquatic/FogRouter.kt
  - LUA: lua/cyboquatic/fog_router.lua
  - SQL: sql/cyboquatic_workload_schema.sql
  - ALN: aln/cyboquatic_workload_ker.aln
- Hex ID reference: phoenix_hex_001 (bound to this shard for canal_node binding)
